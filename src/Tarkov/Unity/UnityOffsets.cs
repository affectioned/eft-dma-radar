namespace eft_dma_radar.Common.Unity
{
    ...
    public readonly struct UnityOffsets
    {
        ...
        /// 
        /// Chain path:
        ///   objectBase + 0x10 �? MonoBehaviour
        ///            + 0x58 �? GameObject
        ///            + 0x58 �? ComponentArray
        ///            + 0x08 �? First component (Transform)
        ///            + 0x30 �? Transform.ObjectClass
        ///            + 0x10 �? TransformInternal
        /// </summary>
        public static readonly uint[] TransformChain =
        [
            ObjectClass.MonoBehaviourOffset,  // 0x10 - ObjectClass �? MonoBehaviour
            Component.GameObject,              // 0x58 - Component �? GameObject
            GameObject.ComponentsOffset,       // 0x58 - GameObject �? ComponentArray
            ComponentArray.Items,              // 0x08 - First transform component
            Transform.ObjectClassOffset,       // 0x30 - Transform �? ObjectClass
            Transform.InternalOffset           // 0x10 - Final �? TransformInternal
        ];
